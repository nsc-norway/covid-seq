...
// pTrimmer_master_file = "$baseDir/util/swift_amplicon_pTrimmer.txt"
// pTrimmer_master_file = "$baseDir/util/swift_amplicon_pTrimmer_750b.txt"
nscTrim_primer_file = "$baseDir/util/sarscov2_v2_masterfile.txt"
